...
//#TPT-Directive ToolClass Tool_Tool11 TOOL_TOOL11 12
...
int Tool_Tool11::Perform(Simulation * sim, Particle * cpart, int x, int y, int brushX, int brushY, float strength)
{
